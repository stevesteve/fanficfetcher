...
class EPub {
     ...
     * @return void
     */
    function __construct($bookVersion = EPub::BOOK_VERSION_EPUB2, $languageCode = "en", $writingDirection = EPub::DIRECTION_LEFT_TO_RIGHT, $zipFileDir = "") {
        ...
        if($zipFileDir == "")
        {
            ...
            $zipFileDir = __DIR__ . "/tmp/" . $dlid;
            echo "writing zip to ".$zipFileDir;
        }
        ...
        $this->initialize();
        $this->zip->setZipFile($zipFileDir);
    }
